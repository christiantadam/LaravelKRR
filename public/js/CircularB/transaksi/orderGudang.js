        ...
        try {
            const result = await Swal.fire({
                ...
                if (result.isConfirmed && result.value) {
                    ...
                    // }, 300);
                    $.ajax({
                        url: "/orderB/show/getOrder2Details",
                        type: "GET",
                        data: {
                            _token: csrfToken,
            ...
            didOpen: () => {
                jQuery(function ($) {
                    const table = $("#kodeTujuanTable").DataTable({
                        ...
                        returnFocus: true,
                        ajax: {
                            url: "/orderB/show/getKodeTujuanSP",
                            dataType: "json",
                            type: "GET",
                            data: {
                                _token: csrfToken,
