...
$("#modal_tambahOrder").on("shown.bs.modal", function () {
    //#region Function Modal Tambah Order
            ...
            success: function (response) {
                if (response.data.length == 0) {
                    ...
                    kategori(response.data[0].no_kat_utama, function () {
                        for (
                            let i = 0;
                            i < select_kategori.options.length;
                            i++
                        ) {
                            if (
                                ...
                                response.data[0].nama_kategori.replace(
                                    /\s/g,
                                    ""
                                )
                            ) {
                    ...
                    subKategori(response.data[0].no_kategori, function () {
                        for (
                            ...
                            if (
                                ...
                                response.data[0].no_sub_kategori.replace(
                                    /\s/g,
                                    ""
                                )
                            ) {
                    ...
                    namaBarang(response.data[0].no_sub_kategori, function () {
                        for (
                            let i = 0;
                            i < select_namaBarang.options.length;
                            i++
                        ) {
                            if (
                    ...
                    for (
                        let i = 0;
                        i < select_kategori_utama.options.length;
                        i++
                    ) {
                        if (
...
//     console.log("Modal hidden. Event deactivated.");

//     // Unbind the event when modal is hidden
