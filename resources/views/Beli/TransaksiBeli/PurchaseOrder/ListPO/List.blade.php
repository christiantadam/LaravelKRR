                        ...
                        <div class="row align-items-end g-3">
                            ...
                            <div class="col-md-5">
                                <div class="form-check mb-2">
                                    <input class="form-check-input" type="radio" name="radiobutton" value="between_date"
                                        checked>
        ...
        <div class="modal-dialog modal-md modal_email_supplier">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>Keterangan: <br>
                        Tujuan email yang diinput bisa lebih dari 1 dengan format sebagai berikut: <br>
                        (Email 1) (Koma) (Spasi) (Email 2) → purchasing.sutindo@gmail.com, purchasing@sutindo.com
                    </p>
                </div>
