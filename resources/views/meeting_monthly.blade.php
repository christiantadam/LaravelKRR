        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div class="d-flex align-items-center">
                <a href="{{ route('meeting.index') }}" class="back-icon me-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#121212" viewBox="0 0 24 24">
            ...
            <div class="d-flex gap-2">
                ...
                <button class="btn btn-primary btn-book" data-room="{{ $room->id }}" data-start="08:00"
                    data-tanggal="{{ date('Y-m-d') }}" data-toggle="modal" data-target="#bookingMeetingModal">
                    + Tambah Meeting
                </button>
            </div>
        </div>
        ...
        <div class="row">
            @forelse($meetings as $meeting)
                <div class="col-md-4 mb-3">
                    <a href="/meeting/{{ $room->id }}?tanggal={{ $meeting->tanggal }}" class="text-decoration-none">
                        ...
                        <div class="card shadow-sm h-100">
                            <div class="card-body">
                                ...
                                <p class="text-muted mb-1 d-flex align-items-center gap-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#3f57e4"
                                        viewBox="0 0 24 24">
                                        <path
                                ...
                                <p class="text-muted small mb-0">
                                    👤 {{ $meeting->NamaUser ?? trim($meeting->pemesan) }}
                                </p>
                            </div>
                        </div>
                    </a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="deskripsi" class="form-control" placeholder="Masukkan tujuan meeting"></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="time" id="jam_akhir" class="form-control" readonly>
                    </div>
