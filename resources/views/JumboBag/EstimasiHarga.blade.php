                    ...
                    <div class="card-body">
                        <form id="PermohonanReturForm" action="{{ route('PermohonanRetur.store') }}" method="POST">
                            ...
                            <div class="d-flex justify-content-center">
                                <button id="btn_isi" style="width: 100px" class="btn btn-primary mx-2">OK</button>
                                <button id="btn_koreksi" style="width: 100px" class="btn btn-warning mx-2">Clear</button>
                            </div>
                            <div>
                                <table id="example">
                                    <thead>
