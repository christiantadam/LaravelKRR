                                ...
                                <div class="acs-div-container toggle-group" id="div_headerSuratPesanan">
                                    ...
                                    <div class="acs-div-container2">
                                        <div class="acs-div-filter">
                                            ...
                                            <textarea name="remarks_quantity" id="remarks_quantity" cols="30" rows="3" class="input">{{ explode(' | ', $header_pesanan[0]->Ket)[2] }}</textarea>
                                        </div>
                                        <div class="acs-div-filter">
                                            <label for="remarks_packing">Packing</label>
                                            <textarea name="remarks_packing" id="remarks_packing" cols="30" rows="3" class="input">{{ explode(' | ', $header_pesanan[0]->Ket)[3] }}</textarea>
                                        </div>
                                        <div class="acs-div-filter">
                                            <label for="remarks_price">Price</label>
                                            <textarea name="remarks_price" id="remarks_price" cols="30" rows="3" class="input">{{ explode(' | ', $header_pesanan[0]->Ket)[4] }}</textarea>
                                        </div>
                                        <div class="acs-div-filter">
                                            <label for="remarks_note">Note</label>
                                            <textarea name="remarks_note" id="remarks_note" cols="30" rows="3" class="input">{{ explode(' | ', $header_pesanan[0]->Ket)[6] ?? '' }}</textarea>
                                        </div>
                                    </div>
                                </div>
