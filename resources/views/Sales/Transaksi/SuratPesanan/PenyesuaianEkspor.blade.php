    ...
    <script>
        ...
        for (var i = 0; i < detailPesananArray.length; i++) {
            var item = [
                ...
                detailPesananArray[i].UraianPesanan.split(" | ")[0] ?? null,
                detailPesananArray[i].UraianPesanan.split(" | ")[1] ?? null,
                detailPesananArray[i].UraianPesanan.split(" | ")[2] ?? null,
                ...
                detailPesananArray[i].UraianPesanan.split(" | ")[3] ?? null,
                detailPesananArray[i].Lunas ?? null,
                detailPesananArray[i].KodeHS ?? null,
            ];
        }
