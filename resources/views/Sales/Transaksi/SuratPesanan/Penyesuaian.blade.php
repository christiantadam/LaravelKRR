    ...
    <div class="col-md-10 RDZMobilePaddingLR0">
        <div class="permohonan-s-p-container">
            <form class="permohonan-s-p-form" id="form_suratPesanan" method="POST"
                action="{{ url('/SuratPesananManager/upPenyesuaian') }}">
                {{ csrf_field() }}
                ...
                @endif
                <legend>Penyesuaian Surat Pesanan</legend>
                <div class="permohonan-s-p-container01">
                    ...
                    <div class="permohonan-s-p-container03">
                        <div class="permohonan-s-p-container04"> <input type="date" id="tgl_pesan" name="tgl_pesan"
                            ...
                            <select name="jenis_sp" id="jenis_sp" class="form-control">
                                ...
                                @foreach ($jenis_sp as $data)
                                    <option value="{{ $data->IDJnsSuratPesanan }}" {{ $data->IDJnsSuratPesanan }}>
                        ...
                        <div class="permohonan-s-p-container06"> <select name="list_customer" id="list_customer"
                                ...
                                @foreach ($list_customer as $data)
                                    ...
                                    @endphp
                                    <option value="{{ $data->IDCUST }}" {{ $data->IDCUST }}>
                                        {{ $companyName }}</option>
                                @endforeach
                        ...
                        <div class="permohonan-s-p-container07"> <input type="text" placeholder="Nomor PO"
                                class="permohonan-s-p-textinput04 input" id="no_po" name="no_po" /> </div>
                    ...
                    <div class="permohonan-s-p-container11" id="inputheader">
                        <div class="permohonan-s-p-container12"> <select name="list_sales" id="list_sales"
                                ...
                                @foreach ($list_sales as $data)
                                    <option value="{{ $data->IDSales }}" {{ $data->IDSales }}>
                        ...
                        <div class="permohonan-s-p-container13"> <input type="text" placeholder="Mata Uang"
                                class="permohonan-s-p-textinput08 input" id="mata_uang" name="mata_uang" /> </div>
                        <div class="permohonan-s-p-container14"> <select name="jenis_bayar" id="jenis_bayar"
                                ...
                                @foreach ($jenis_bayar as $data)
                                    <option value="{{ $data->IdPembayaran }}" {{ $data->IdPembayaran }}>
                        ...
                        <div class="permohonan-s-p-container15"> <input type="text"
                                ...
                                placeholder="0" /> <span class="permohonan-s-p-text11"> <span>Hari</span> <br /> </span>
                            <span class="permohonan-s-p-text14"> <span>Faktur PJK:</span> <br /> </span> <input
                                type="radio" class="permohonan-s-p-radiobutton" id="faktur_pjk0" name="faktur_pjk"
                                value="0" required /> <span class="permohonan-s-p-text17">
                                <span>Biasa</span>
                                <br /> </span> <input type="radio" class="permohonan-s-p-radiobutton1" id="faktur_pjk1"
                                name="faktur_pjk" value="1" /> <span class="permohonan-s-p-text20">
                                <span>Sederhana</span> <br />
                            </span>
                        </div>
                        <div class="permohonan-s-p-container16"> <input type="text" id="keterangan" name="keterangan"
                                placeholder="Keterangan" class="permohonan-s-p-textinput11 input" /> </div>
                    ...
                    <table class="permohonan-s-p-table" id="list_view" name="list_view">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th>B.KertasMTR</th>
                                <th>BS.TotalMTR</th>
                                <th style="display: none">IDPesanan</th>
                            </tr>
                        </thead>
                        <tbody>
        ...
        <script type="text/javascript" src="{{ asset('js/Sales/penyesuaian-s-p.js') }}"></script>
    </div>
@endsection
