@extends('layouts.appSales') @section('content')
    ...
    <div class="col-md-10 RDZMobilePaddingLR0">
        ...
        <div class="permohonan-sj-container">
            <form method="POST" enctype="multipart/form-data" id="form_suratJalan" class="permohonan-sj-form"
                action="{{ url('SuratJalan') }}">
                {{ csrf_field() }}
                <legend>Surat Jalan</legend>
                <div class="permohonan-sj-form" id="div_suratJalan">
                    <div class="permohonan-sj-container01">
                        <span>Id Kirim</span>
                        <input type="text" name="id_kirimText" id="id_kirimText" class="input" readonly>
                        <select class="permohonan-sj-select input" name="id_kirimSelect" id="id_kirimSelect"
                            style="display: none">
                            <option disabled selected>-- Pilih Id Kirim --</option>
                        </select>
                        <button disabled id="list_sjButton" class="permohonan-sj-button button">Lihat Data</button>
                        <span>Keterangan</span>
                        <textarea placeholder="Keterangan" id="keterangan" name="keterangan" class="permohonan-sj-textarea textarea"></textarea>
                    </div>
                    <div class="permohonan-sj-container02">
                        ...
                        <select class="permohonan-sj-select input" name="jenis_pengiriman" id="jenis_pengiriman">
                            ...
                            @foreach ($jenisPengiriman as $data)
                                <option value="{{ $data->IDJnsSuratJalan }}">{{ $data->NamaJnsSuratJalan }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="permohonan-sj-container04">
                        <span>Tanggal</span>
                        <input type="date" id="tanggal" name="tanggal" placeholder="placeholder" class="input" />
                    ...
                    <div class="permohonan-sj-container06">
                        ...
                        <select class="permohonan-sj-select2 input" id="expeditor" name="expeditor">
                            ...
                            @foreach ($expeditor as $data)
                                <option value="{{ $data->IDEXPEDITOR }}">{{ $data->NAMAEXPEDITOR }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="permohonan-sj-container08">
                        ...
                        <div class="permohonan-sj-container12">
                            <button id="add_item" name="add_item" type="button" class="permohonan-sj-button button">
                                Add Item
                            </button>
                            <button id="remove_item" name="remove_item" type="button" class="permohonan-sj-button1 button">
                                Remove Item
                            </button>
                        </div>
                    </div>
