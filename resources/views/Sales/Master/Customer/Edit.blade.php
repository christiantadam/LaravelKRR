                ...
                <div class="card">
                    ...
                    <div class="card-body RDZOverflow RDZMobilePaddingLR0">
                        <div class="permohonan-do-container">
                            <form class="permohonan-do-form" method="POST"
                                action="{{ route('customer.update', $model->IDCust) }}" id="FormCustomer">
                                {{ csrf_field() }}
                                        ...
                                        <div class="acs-form1">
                                            ...
                                            <div class="acs-div-filter">
                                                ...
                                                <input type="text" name="LimitBeli"
                                                    id="LimitBeli"value="{{ $model->LimitBeli }}"
                                        ...
                                        <div class="acs-form1">
                                            <div class="acs-div-filter">
                                                ...
                                                <input type="text" name="NoTelp1" id="NoTelp1"
                                                    value="{{ $model->NoTelp1 }}" placeholder="No Telpon 1"
                                                    class="input">
                                            </div>
                                            <div class="acs-div-filter">
                                                <label for="NoTelp2">No Telpon 2</label>
                                                <input type="text" name="NoTelp2" id="NoTelp2"
                                                    value="{{ $model->NoTelp2 }}" placeholder="No Telpon 2"
                                                    class="input">
                                            </div>
                                            <div class="acs-div-filter">
                                            ...
                                            <div class="acs-div-filter">
                                                ...
                                                <input type="text" name="KotaKirim" id="KotaKirim"
                                                    value="{{ $model->KotaKirim }}" placeholder="Kota Kirim"
                                                    class="input">
                                            </div>
                                        </div>
                                        <div class="acs-form1">
                                            ...
                                            <div class="acs-div-filter">
                                                ...
                                                <input type="text" name="AlamatNPWP"
                                                    id="AlamatNPWP"value="{{ $model->AlamatNPWP }}"
