    ...
    <div style="display: flex;flex-direction: row;gap: 1px;padding-bottom: 5px">
        ...
        <div style="flex: 0.3;">
            ...
            {{-- <div style="position: relative; display: inline-block;">
                ...
                <input type="text" id="hasil_cetakOpenTopGambarInputBB" name="hasil_cetakOpenTopGambarInputBB"
                    style="position: absolute; top: 78.5%; left: 0; width: 13.5%; background-color: white;border:none;"
                    value="{{ number_format($blockBottom, 2, '.', ',') }}" disabled>
                <input type="text" id="hasil_cetakOpenTopGambarInputBC" name="hasil_cetakOpenTopGambarInputBC"
                ...
                <input type="text" id="hasil_cetakOpenTopGambarInputVS" name="hasil_cetakOpenTopGambarInputVS"
                ...
                <input type="text" id="hasil_cetakOpenTopGambarInputVL" name="hasil_cetakOpenTopGambarInputVL"
                ...
                <input type="text" id="hasil_cetakOpenTopGambarInputW" name="hasil_cetakOpenTopGambarInputW"
                    style="position: absolute; top: -0.7%; left: 46.5%; width: 17%; background-color: white;border:none;"
                    value="{{ number_format($width, 2, '.', ',') }}" disabled>
                <input type="text" id="hasil_cetakOpenTopGambarInputH" name="hasil_cetakOpenTopGambarInputH"
                    style="position: absolute; top: 44%; left: 88.2%; width: 12%; background-color: white;border:none;"
                    value="{{ number_format($height, 2, '.', ',') }}" disabled>
                <input type="text" id="hasil_cetakOpenTopGambarInputFA" name="hasil_cetakOpenTopGambarInputFA"
