                ...
                <div class="card-body RDZOverflow RDZMobilePaddingLR0">
                    <div class="form-container col-md-12">
                        <form method="POST" action="{{ url('MaintenanceBKMPenagihan') }}" id="formkoreksi">
                            ...
                            <div class="d-flex">
                                <div class="col-md-2">
                                    <label for="bulanTahun" style="margin-right: 10px;">Bulan/Tahun (Untuk contoh
                                        11/2010)</label>
                                </div>
                                <div class="col-md-1">
                            ...
                            <div class="card-container" style="display: flex;">
                                <div class="card" style="width: 40%;">
                                    <div class="card-body">
                                        <div class="col-md-12">
                                            <input type="radio" name="radiogrupDetail" value="1"
                                ...
                                <div class="card" style="width: 30%; overflow-y: auto; max-height: 250px;">
                                    <div class="card-body">
                                        <div class="col-md-12">
                                            <input type="radio" name="radiogrupDetail" value="2"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form method="POST" action="{{ url('MaintenanceBKMPenagihan') }}"
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="d-flex">
                                                    <div class="col-md-3">
                                                        <label for="pelunasanRupiah"
                                                            style="margin-right: 10px;">Pelunasan
                                                            Rupiah</label>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <input type="text" id="pelunasanRupiah"
                                                            name="pelunasanRupiah" class="form-control"
                                                            style="width: 100%">
                                                    </div>
                                                </div>
                                                <div class="d-flex">
                                                ...
                                                <div class="row">
                                                    <div class="col-5">
                                                        <input type="submit" id="btnProsesDetail"
                                                            name="btnProsesDetail" value="Proses"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ url('UpdateDetailBKM') }}" id="formDetailBiaya"
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="col-md-7">
                                                    <select name="kodePerkiraanBiayaSelect"
                                                        id="kodePerkiraanBiayaSelect" class="form-control">
                        ...
                        <div class="modal-content" style="padding: 25px;">
                            ...
                            <form action="{{ url('MaintenanceBKMPenagihan') }}" id="formTampilBKM" method="POST">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="col-md-3">
                                        <input type="date" id="tanggalInputTampil" name="tanggalInputTampil"
                                            class="form-control" style="width: 100%">
                                    </div>
                                    <div class="col-md-1">
                                        S/D
                                    ...
                                    <div class="col-md-3">
                                        <input type="date" id="tanggalInputTampil2" name="tanggalInputTampil2"
                                            class="form-control" style="width: 100%">
                                    </div>
                                    <div class="col-md-3">
