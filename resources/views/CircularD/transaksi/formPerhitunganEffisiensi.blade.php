...
@section('content')
                    ...
                    <div class="card-body RDZOverflow RDZMobilePaddingLR0">
                        <div class="form-container col-md-12">
                            <form method="POST" action="">
                                ...
                                <div class="d-flex">
                                    <div class="col-md-1">
                                        <input type="input" id="mesin" class="form-control" style="width: 100%; text-align: center;">
                                    </div>
                                    <div class="col-md-1">
                                        <input type="input" id="ukuran" class="form-control" style="width: 100%; text-align: center;">
                                    </div>
                                    <div class="col-md-2">
                                        <input type="input" id="rajutan" class="form-control" style="width: 100%; text-align: center;">
                                    </div>
                                    <div class="col-md-1">
                                        <input type="input" id="rpm" class="form-control" style="width: 100%; text-align: center;">
                                    </div>
                                    <div class="col-md-1">
                                        <input type="input" id="shutle" class="form-control" style="width: 100%; text-align: center;">
                                    </div>
                                    <div class="col-md-1">
                                        <input type="input" id="hsl_meter" class="form-control" style="width: 100%; text-align: center;">
                                    </div>
                                    <div class="col-md-1">
                                        <input type="input" id="effisiensi" class="form-control" style="width: 100%; text-align: center;">
                                    </div>
                                </div>
                                <hr style="height:2px;">
    ...
    <script src="{{ asset('js/CircularD/transaksi/PerhitunganEffisiensi.js') }}"></script>
@endsection
