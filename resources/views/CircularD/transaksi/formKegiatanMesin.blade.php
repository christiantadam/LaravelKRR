...
@section('custom_js')
    <script>
        const url_MesinOrder = "{{ url('/paginationD/get-mesin-order') }}";
        const url_DaftarPegawai = "{{ url('/paginationD/get-pegawai') }}";
        const url_IdLog = "{{ url('/paginationD/get-log-mesin') }}";
    </script>

    @include('CircularD.transaksi.modalpegawai')
    <script src="{{ asset('js/CircularD/transaksi/kegiatanMesin.js') }}"></script>
@endsection
