...
@section('content')
                    ...
                    <div class="card-body RDZOverflow RDZMobilePaddingLR0">
                        <div class="form-container col-md-12">
                            ...
                            <div class="row pb-2">
                                ...
                                <div class="col-sm-2">
                                    <input type="text" class="form-control" id="id_typeMesin" name="id_typeMesin"
                                        readonly>
                                </div>
                                <div class="col-sm-5">
                            ...
                            <div class="row pb-2">
                                ...
                                <div class="col-sm-2">
                                    <input type="text" class="form-control" id="id_namaMesin" name="id_namaMesin"
                                        readonly>
                                </div>
                                <div class="col-sm-5">
    ...
    <script src="{{ asset('js/CircularD/transaksi/MaintenanceJamGangguan.js') }}"></script>
@endsection
