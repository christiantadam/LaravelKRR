    ...
    <div class="modal-dialog" style="max-width: 90%;">
        <div class="modal-content">
            <div class="modal-header justify-content-center">
                ...
                <button type="button" class="close" id="closeModalButtonTanpaBarcode">
                    <span>&times;</span>
                </button>
            </div>
            <div class="modal-body" id="modalBodyTambahTujuanKonversiTanpaBarcode">
                <div style="display: flex; flex-direction: row;gap:1%;border: 1px solid rgba(0, 0, 0, 0.5);padding:0.5%;margin: 0.5%;"
                    ...
                    <div class="form-group" style="width: 8%">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" id="group_TanpaBarcode" name="group_TanpaBarcode"
                                placeholder="[A] [B] [C]">
                        </div>
                    </div>
                    ...
                    <div class="form-group" style="width: 20%">
                        ...
                        <div class="input-group">
                            <select name="select_customerTanpaBarcode" id="select_customerTanpaBarcode"
                                class="form-control">
                                @foreach ($customer as $c)
                                    <option value="{{ $c->IDCust }}">{{ $c->NamaCust }} |
                                        {{ $c->IDCust }}</option>
                                @endforeach
                            </select>
                        </div>
                            ...
                            <table id="table_daftarTujuanKonversiTanpaBarcode">
                                <thead>
                                    <tr style="white-space: nowrap">
                                        ...
                                        <th>Jumlah Pemasukan Primer</th>
                                        <th>Satuan Primer</th>
                                        <th>Jumlah Pemasukan Sekunder</th>
