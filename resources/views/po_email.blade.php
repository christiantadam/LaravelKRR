                ...
                @if ($header->StatusBeli == 1)
                    @if (!empty($ttdBase64_2))
                        @if (!empty($ttdBase64_1))
                            ...
                            <div style="position: absolute;top: 25.2cm;left: 2cm;display: grid;place-items: center;">
                                <label style="font-size: 10px;">{{ $header->NamaDirektur }}</label>
                            </div>
                        @endif
                        @if (!empty($ttdBase64_2))
                            <div style="position: absolute;top: 22.8cm;left: 5.2cm;display: grid;place-items: center;">
                                <img src="{{ $ttdBase64_2 }}" class="signature_img">
                            </div>
                            <div style="position: absolute;top: 25.2cm;left: 5cm;display: grid;place-items: center;">
