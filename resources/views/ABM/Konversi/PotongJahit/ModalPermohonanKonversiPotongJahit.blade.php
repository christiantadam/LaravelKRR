<div class="modal fade" id="konversiPotongJahitModal" tabindex="-1" data-bs-backdrop="static">
    <div class="modal-dialog" style="max-width: 90%;">
        <div class="modal-content" id="select2DropdownParent">
            <div class="modal-header justify-content-center">
                <h5 class="modal-title" id="konversiPotongJahitModalLabel">Tambah Konversi Potong Jahit </h5>
                    ...
                    <div class="card" style="width: 100%;margin: 0.5%;padding:0.5%;">
                        ...
                        <div style="display: flex; flex-direction: row;gap:0.5%;">
                            ...
                            <div class="form-group" style="width: 8%">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" id="shiftMPJ" name="shiftMPJ"
                                        placeholder="[A] [B] [C]">
                                </div>
                            </div>
                            <div class="form-group" style="width: 12%">
                            ...
                            <div class="form-group" style="width: 12%">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="select_kodeBarangHasil" id="select_kodeBarangHasil"
                                        class="form-control">
                                    </select>
                                </div>
                            </div>
                            <div class="form-group" style="width: 48%">
                                ...
                                <div class="input-group">
                                    <textarea class="form-control" id="nama_barangHasil" name="nama_barangHasil" readonly> </textarea>
                                </div>
                            </div>
                        </div>
                        <div style="display: flex; flex-direction: row;gap:0.5%;">
                            ...
                            <div class="form-group" style="width: 8%">
                                <label for="hasil_kg">Hasil Kg Bruto</label>
                                <div class="input-group">
