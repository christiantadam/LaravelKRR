                    ...
                    <form id="maintenanceMesin" action="{{ url('MaintenanceMesin') }}" method="POST">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-lg-7">
                                <div class="row">
                                    <div class="col-5">
                                        <select class="form-select" name="mesin"
                                            style="width: 36vh;
                                      height: 6vh;"
                                            id="mesin" disabled>
                                            <option disabled selected>Pilih Mesin</option>
                                        </select>
                                        <input type="text" name="isiMesin" class="form-control" style="display: none"
                                            id="isiMesin">
                                    </div>
                                    <div class="col-5">
                                        <button class="btn btn-light" onclick="tukar(event)" id="ganti"
                                            disabled>ganti</button>
                                    </div>
                                </div>
                            </div>
                        </div>
