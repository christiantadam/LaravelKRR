                ...
                <div class="card-body">
                    <form id="maintenanceDrafter" action="{{ url('MaintenanceDrafter') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <select class="form-select" name="UserDrafter"
                                    style="width: 36vh;
                                height: 6vh;" id="UserDrafter">
                                    <option disabled selected>Pilih Drafter</option>
                                    @foreach ($drafter as $d)
                                        <option value="{{ $d->IdUser }}">{{ $d->IdUser }} -- {{ $d->NamaPembuat }}
                                        </option>
                                    @endforeach
                                </select>
                                <input type="text" name="UsrDraf" class="form-control" id="UsrDraf"
                                    style="display: none" maxlength="3">
                            </div>
                        </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-lg-8" style="text-align-last: center;">
                                <div class="justify-content-center">
                                    ...
                                    <button type="button" class="btn btn-danger custom-btn" id="batal"
                                        style="display: none" onclick="bataldiklik()"><u>B</u>atal</button>
