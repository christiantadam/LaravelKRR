            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form id="formUpdateGambar" action="{{ url('UpdateNoGambar') }}" method="POST">
                        ...
                        <div class="float-end">
                            <button type="button" class="btn btn-primary custom-btn" onclick="klikproses()"
                                id="proses" disabled><u>P</u>ROSES</button>
                            <button type="button" class="btn btn-danger custom-btn" onclick="klikbatal()" disabled
                                id="batal"><u>B</u>atal</button>
                        </div>
                    </form>
                </div>
            </div>
