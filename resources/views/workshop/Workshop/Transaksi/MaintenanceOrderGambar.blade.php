                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="table-responsive" style="margin-top: 5vh">
                                <table class="table mt-3" style="width: max-content;" id="tableklik">
                                    ...
                                    <tbody id="datatable" style="width: max-content"> </tbody>
                                </table>
                            </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <form id="formMaintenanceOrderGambar" method="POST">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="date" name="acc_manager" class="form-control"
                                            id="acc_manager" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="date" name="acc_direktur" class="form-control"
                                ...
                                <div class="row mt-3">
                                    <div class="col-lg-5">
                                        <span class="custom-alignment" style="white-space: nowrap">Tgl. tdk disetujui
                                            Manager:</span>
                                    </div>
                                    <div class="col-lg-6">
                                        <input type="date" name="tgl_manager" class="form-control"
                                            id="tgl_manager" readonly>
                                    </div>
                                </div>

                                <div class="row mt-3">
                                    <div class="col-lg-5">
                                        <span class="custom-alignment" style="white-space: nowrap">Ket. tdk disetujui
                                            Manager:</span>
                                    </div>
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-12 content-center">
                                        <div>
                                            <button type="button" class="btn btn-success custom-btn"
                                                onclick="klikisi()" id="isi">ISI</button>
                                            <button type="button" class="btn btn-warning custom-btn"
                                                onclick="klikkoreksi()" id="koreksi">KOREKSI</button>
            ...
            <form method="post" id="formbaru" action="{{ url('MaintenanceOrderGambar') }}">
                ...
                <div class="modal-body">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-lg-8"> <!-- Updated class: col-lg-8 -->
                            <div class="input-group">
                                <input type="number" name="jumlahbaru" class="form-control" value="1"
                                    id="jumlahbaru">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-lg-8"> <!-- Updated class: col-lg-8 -->
                            <div class="input-group">
                                <select class="form-select" name="Mesin" style="width: 36vh; height: 6.6vh;"
                                    id="Mesin">
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-lg-8"> <!-- Updated class: col-lg-8 -->
                            <input type="text" name="PengorderBaru" class="form-control" id="PengorderBaru"
                                readonly style="color: blue;font-weight: bold;">
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-body">
                    <div class="container">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-lg-8"> <!-- Updated class: col-lg-8 -->
                                <input type="text" name="KeteranganModif" class="form-control"
                                    id="KeteranganModif">
                            </div>
                        </div>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-lg-8"> <!-- Updated class: col-lg-8 -->
                                <input type="text" name="PengorderBaru" class="form-control" id="PengorderModif"
                                    readonly style="color: blue;font-weight: bold;">
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col" style="padding-left: 37vh" hidden>
                                <div class="row">
                                    ...
                                    <div class="col-8"> <!-- Updated class: col-lg-8 -->
                                        <input type="text" name="lblKdDivisi" class="form-control"
                                            id="pembedaStore">
                                    </div>
                                </div>
                            </div>
