            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Perbaikan
                        <a class="AddNota btn btn-primary btn-sm" href="" style="float:right;margin-right: 1px">ADD</a>
                    </div>
                            ...
                            <tbody>
                                @foreach ($CartridgeService as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="DetailRefill btn btn-primary btn-xs RDZEditDelTBL"
                                                style="border: 1px solid #212529;border-radius: 5px;"
                                                data-id="{{ $item->id }}">Detail</a>
                                            <a href="{{ route('perbaikancartridge.show', ['id' => $item->id]) }}"
                                                class="btn btn-warning btn-xs RDZEditDelTBL"
                                                style="border: 1px solid #212529;border-radius: 5px;"
