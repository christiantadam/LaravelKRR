...
class OpenTop extends Controller
{
    ...
    {
        $result = (new HakAksesController)->HakAksesFitur('Open Top');
        $access = (new HakAksesController)->HakAksesFiturMaster('AD Star');
        $user = Auth::user()->NomorUser;

        if ($result) {
            return view('AdStar.OpenTop', compact('access', 'user'));
        } else {
    ...
    public function store(Request $request)
    {
        ...
        $tableHitungan_M1 = $request->tableHitungan_M1;
        $tableHitungan_M2 = $request->tableHitungan_M2;
        $tableHitungan_M3 = $request->tableHitungan_M3;
        $tableHitungan_M4 = $request->tableHitungan_M4;
        $tableHitungan_M5 = $request->tableHitungan_M5;
        $tableHitungan_M6 = $request->tableHitungan_M6;
        $tableHitungan_M7 = $request->tableHitungan_M7;
        $tableHitungan_M8 = $request->tableHitungan_M8;
        $tableHitungan_WA1 = $request->tableHitungan_WA4;
        $tableHitungan_WE1 = $request->tableHitungan_WA4;
        $tableHitungan_WA2 = $request->tableHitungan_WA4;
        $tableHitungan_WE2 = $request->tableHitungan_WA4;
        $tableHitungan_WA3 = $request->tableHitungan_WA4;
        $tableHitungan_WE3 = $request->tableHitungan_WA4;
        $tableHitungan_WA4 = $request->tableHitungan_WA4;
        $tableHitungan_WE4 = $request->tableHitungan_WA4;
        ...
        try {
            DB::connection('ConnAdStar')->
                statement('exec SP_1486_ADSTAR_MAINT_TABEL_HITUNGAN
                    ...
                    $keterangan,
                    $tableHitungan_WA4,
                    $tableHitungan_Denier7,
                    $tableHitungan_C7,
                    $tableHitungan_WE4,
                    $tableHitungan_Denier8,
                    $tableHitungan_C8,
                    $tableHitungan_M3,
                    $tableHitungan_M4,
                    $tableHitungan_M5,
                    ...
                    $tableHitungan_WA4,
                    $tableHitungan_WE4,
                    $tableHitungan_Denier3,
                    $tableHitungan_Denier4,
                    $tableHitungan_Denier5,
                    $tableHitungan_Denier6,
                    $tableHitungan_Denier7,
                    $tableHitungan_Denier8,
                    $tableHitungan_C3,
                    $tableHitungan_C4,
            ...
            if ($kode == 1) {
                return response()->json(['success' => 'Data Tabel Hitungan Open Top berhasil ditambahkan!']);
            } else if ($kode == 2) {
                return response()->json(['success' => 'Data Tabel Hitungan Open Top berhasil diupdate!']);
            } else if ($kode == 3) {
                return response()->json(['success' => 'Data Tabel Hitungan Open Top berhasil dihapus!']);
            }
        } catch (Exception $ex) {
    ...
    public function show($id, Request $request)
    {
        if ($id == 'getListCustomerAdd') {
            ...
            $dataCustomerUpdate = DB::connection('ConnAdStar')->select('exec SP_1486_ADSTAR_LIST_TABEL_HITUNGAN @Kode = 3');
            ...
            $idCustomer = $request->idCustomer;
            $dataProduct = DB::connection('ConnAdStar')->select('exec SP_1486_ADSTAR_LIST_TABEL_HITUNGAN @Kode = 1, @idCust = ?', [$idCustomer]);
