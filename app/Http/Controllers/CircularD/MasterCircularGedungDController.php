...
class MasterCircularGedungDController extends Controller
{
    public function index($form_name)
    {
        ...
        switch ($form_name) {
            ...
            case 'formKelompokLokasi':
                ...
                break;
            default:
                return view('CircularD.master.' . $form_name, compact('access'));
        }
        // dd($form_data);
        return view('CircularD.master.' . $form_name, $form_data, compact('access'));
    }
