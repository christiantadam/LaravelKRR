...
class InformasiCircularDController extends Controller
{
    public function index($form_name)
    {
        ...
        switch ($form_name) {
            case 'formCounterMesin':
                ...
                break;
            default:
                return view('CircularD.informasi.' . $form_name, compact('access'));
        }

        return view('CircularD.informasi.' . $form_name, $form_data, compact('access'));
    }
